...
//Import do arquivo de padronização de messages
    ...
    try{
        ...
        if(String(contentType).toUpperCase() == 'APPLICATION/JSON'){
            ...
            if(validar){
                ...
                if(result){ //201
                    //Criando o atributo ID no JSON do genero e colocando o ID gerado após o insert
                    genero.id = result
...
const atualizarProduto = async function (produto,id, contentType) {
    ...
    try{
        ...
        if(String(contentType).toUpperCase() == 'APLICATION/JSON'){
            ...
            //isso significa que o genero existe na base, caso não retorne true,
            ...
            if(resultBuscarID.status){
                ...
                if(!validar){
                    ...
                    //chama a função do DAO para atualizar o genero ( dados e ID)
...
message.SUCCESS_UPDATED_ITEM.message
                ...
                return resultresultBuscarID //400, 404 ou 500
            }
